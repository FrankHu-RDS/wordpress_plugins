		...
		return array(
			...
			'borders' => array(
				'page' => array(
					...
					'css'          => array(
						'main' => array(
							'border_radii'  => "{$this->main_css_element} .dipl_facebook_embedded_page",
							'border_styles' => "{$this->main_css_element} .dipl_facebook_embedded_page",
						),
						'important' => 'all',
					),
					'tab_slug'     => 'advanced',
			...
			'box_shadow' => array(
				'page' => array(
					...
					'css'         => array(
						'main' => "{$this->main_css_element} .dipl_facebook_embedded_page",
						'important' => 'all',
					),
					'tab_slug'    => 'advanced',
