...
class DIPL_Timeline_Item extends ET_Builder_Module {
		...
		return array(
			...
			'borders'        => array(
				'default' => array(
					'css' => array(
						'main' => array(
							'border_radii'  => '%%order_class%%.dipl_timeline_item .dipl_item_content',
							'border_styles' => '%%order_class%%.dipl_timeline_item .dipl_item_content',
						),
					),
				),
			),
			...
			'background'     => array(
				...
				'css'                  => array(
					'main' => '.dipl_timeline %%order_class%%.dipl_timeline_item .dipl_item_content',
				),
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$single_icon_shape_border_size  = esc_attr( $this->props['single_icon_shape_border_size'] );
		$header_level                   = esc_attr( $this->props['single_timeline_header_level'] ) ? esc_attr( $this->props['single_timeline_header_level'] ) : 'h3';
		$timeline_date                  = '';
		$output                         = '';
