...
class DIPL_ImageMask extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$scale_mask               = esc_attr( intval( $this->props['scale_mask'] ) );
		...
		if ( '' !== $scale_mask ) {
			$scale = sprintf( 'scale(%1$s)', esc_html( $scale_mask ) );
		}

		if ( '' !== $rotate_mask ) {
			$rotate = sprintf( 'rotate(%1$s)', esc_html( $rotate_mask ) );
		}
		...
		if ( '' !== $scale || '' !== $rotate ) {
			self::set_style(
				...
				array(
					...
					'declaration' => sprintf( 'transform: %1$s %2$s;', esc_html( $scale ), esc_html( $rotate ) ),
				)
			);
		}
		...
		if ( '' !== $horizontal_mask_position ) {
			self::set_style(
				...
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-webkit-mask-position-x: %1$s;', esc_html( $horizontal_mask_position ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-moz-mask-position-x: %1$s;', esc_html( $horizontal_mask_position ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-o-mask-position-x: %1$s;', esc_html( $horizontal_mask_position ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( 'mask-position-x: %1$s;', esc_html( $horizontal_mask_position ) ),
				)
			);
		}
		...
		if ( '' !== $vertical_mask_position ) {
			self::set_style(
				...
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-webkit-mask-position-y: %1$s;', esc_html( $vertical_mask_position ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-moz-mask-position-y: %1$s;', esc_html( $vertical_mask_position ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-o-mask-position-y: %1$s;', esc_html( $vertical_mask_position ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( 'mask-position-y: %1$s;', esc_html( $vertical_mask_position ) ),
				)
			);
		}
		...
		if ( '' !== $mask_type ) {
			...
			self::set_style(
				...
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-webkit-mask-image: url(%1$s);', esc_html( $mask_url ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-moz-mask-image: url(%1$s);', esc_html( $mask_url ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( '-o-mask-image: url(%1$s);', esc_html( $mask_url ) ),
				)
			);
			self::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dipl_image_mask_container .dipl_image_mask_inner',
					'declaration' => sprintf( 'mask-image: url(%1$s);', esc_html( $mask_url ) ),
				)
			);
		}
