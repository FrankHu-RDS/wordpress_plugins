...
class DIPL_BeforeAfterSlider extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug ) {
		...
		$this->add_before_after_slider_dependencies();
