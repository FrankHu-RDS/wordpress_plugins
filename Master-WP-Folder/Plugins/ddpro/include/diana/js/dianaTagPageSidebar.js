(function ($) {
    $('body.archive.tag .et_pb_post .post-meta').each(function () {
    ...
    $('body.archive.tag .et_pb_post').each(function () {
    ...
    setInterval(function () {
        if(!$('body.archive.tag .et_pb_posts article').hasClass('done')){
            $('body.archive.tag .et_pb_post .post-meta').each(function () {
                var author = $(this).find('span.author')[0];
                var date = $(this).find('span.published')[0];
                var categories = $(this).find('a[rel="category tag"]').toArray();
            ...
            $('body.archive.tag .et_pb_posts article').addClass('done');
        }
    },50);
})(jQuery);