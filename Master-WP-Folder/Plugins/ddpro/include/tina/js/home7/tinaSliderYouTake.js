...
(function ($) {
    ...
    setTimeout(function () {
        ...
        if($('body:not(.et-fb) .tina_slider_you_take').length !== 0){
            ...
            // $('.tina_slider_you_take .et_pb_slider .et_pb_slide').each(function () {
            ...
            //
            // $('.tina_slider_you_take .et_pb_slider .et_pb_slide').hover(function () {
            ...
            //             // self.hoverTlShadow.to($(this), 0.2, {rotationX: -5, skewX: 2, x: transformSize2}, "start")
            //             //     .to($(this), 0.2, {rotationX: 0, skewX: 0, x: transformSize2}, "end");
            //         })
