(function ($) {
    ...
    var ragnarContentBear  = 1000;

    if (isIE()) {
        ragnarContentBear = 10000;
    }
    ...
    setTimeout(function () {
        ...
        if($('.ragnar_content_bear').length !== 0){
            for(i=0; i < 1925; i++){
                $('<div class="map_dot map_dot_'+ i +'"></div>').appendTo($('.ragnar_content_bear .map_row .et_pb_column'))
            }
            ...
            $.each(northAmerica, function (i, val){
                $('.map_dot_' + val).addClass('basic')
            })

            setInterval(function (){
                $('.ragnar_content_bear .basic.map_dot_' + northAmerica[Math.floor(Math.random() * northAmerica.length)]).addClass("animated").delay(3000).queue(function(){
                    $(this).removeClass("animated").dequeue();
                });
            },10)
            setInterval(function (){
                $('.ragnar_content_bear .basic.map_dot_' + northAmerica[Math.floor(Math.random() * northAmerica.length)]).addClass("animated").delay(5000).queue(function(){
                    $(this).removeClass("animated").dequeue();
                });
            },15)

            setInterval(function (){
                $('.ragnar_content_bear .basic.map_dot_' + northAmerica[Math.floor(Math.random() * northAmerica.length)]).addClass("animated2").delay(2000).queue(function(){
                    $(this).removeClass("animated2").dequeue();
                });
            },20)

            setInterval(function (){
                $('.ragnar_content_bear .basic.map_dot_' + northAmerica[Math.floor(Math.random() * northAmerica.length)]).addClass("animated3").delay(1000).queue(function(){
