...
$allow_cname = false;
if ($user_credits->account->agency_quota >= WPS_IC_GB * 10) {
	$allow_cname = true;
}

if ($user_credits->bytes->monthly >= WPS_IC_GB * 10) {
	$allow_cname = true;
}
    ...
    <div class="wp-compress-header">
      ...
      <div class="wp-ic-header-buttons-container">
        <ul>
          ...
          <li><a href="<?php echo admin_url('admin.php?page=wpcompress'); ?>" class="button button-primary button-grd">Save</a></li>
        </ul>
      ...
      <div class="inner">
        ...
        <div class="setting-group">
          ...
          <div class="setting-value">
            <div class="checkbox-container-v2 informative-input" style="display: inline-block;">
        ...
        <div class="setting-group">
          ...
          <div class="setting-value">
            <div class="checkbox-container-v2 informative-input <?php echo $locked_css_class; ?>" <?php echo $locked_tooltip; ?> style="display: inline-block;">
            ...
            <div class="checkbox-container-v2 informative-input <?php echo $locked_css_class; ?>" <?php echo $locked_tooltip; ?> style="display: inline-block;">
              ...
              <div>
                <label for="css_image_urls-toggle" class="css_image_urls-toggle"></label>
								<?php if ($settings['css_image_urls'] == '1') { ?>
                  <span>ON</span>
								<?php } else { ?>
                  <span>OFF</span>
								<?php } ?>
        ...
        <div class="setting-group">
          ...
          <div class="setting-value">
            <div class="checkbox-container-custom <?php echo $locked_css_class; ?>" <?php echo $locked_tooltip; ?> style="display: inline-block;">
              ...
              <div>
                <label for="external-url-toggle" class="external-url-toggle"></label>
								<?php if ($settings['external-url'] == '1') { ?>
                  <span>ON</span>
								<?php } else { ?>
                  <span>OFF</span>
								<?php } ?>
            ...
            <?php /*
            <div class="setting-additional">
              <span class="tooltip" title="Configure additional parameters for this option.">
                <a href="#" class="wps-ic-additional-configuration" data-popup="external-url">
        ...
        <div class="setting-group">
          ...
          <div class="setting-value">
            <div class="checkbox-container-v2 informative-input whole-checkbox <?php echo $locked_css_class; ?>" <?php echo $locked_tooltip; ?> style="display: inline-block;">
              ...
              <div>
                <label for="emoji-remove-toggle" class="emoji-remove-toggle"></label>
								<?php if ($settings['emoji-remove'] == '1') { ?>
                  <span>ON</span>
								<?php } else { ?>
                  <span>OFF</span>
								<?php } ?>
        ...
        <input type="submit" class="button button-primary button-bigger button-save-settings"  value="Save"/>
            ...
            <div class="setting-value">
							...
							if ( ! empty($_POST['cname'])) {
								...
								if (empty($error)) {
									...
									if ( ! preg_match('/^([a-zA-z0-9\_\-]+)\.([a-zA-z0-9\_\-]+)\.([a-zA-z0-9\_\-]+)$/', $cname, $matches)) {
